IF EXISTS (SELECT TOP(1) 1 FROM SYSOBJECTS WHERE id = OBJECT_ID('sp_get_messages_sent_to') AND OBJECTPROPERTY(id, 'IsProcedure') = 1)
	DROP PROCEDURE sp_get_messages_sent_to
GO
